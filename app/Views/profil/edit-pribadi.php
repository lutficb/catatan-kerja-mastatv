        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        ...
                        $tempatData = [
                            ...
                            'name'  => 'tempat_lahir',
                            'id'    => 'tempat_lahir',
                            'value' => old('tempat_catatan', $user['tempat_lahir']),
                            'class' => 'form-control',
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        ...
                        $tglData = [
                            ...
                            'name'  => 'tanggal_lahir',
                            'id'    => 'tanggal_lahir',
                            'value' => old('waktu_catatan', date('Y-m-d', strtotime($user['tanggal_lahir']))),
                            'class' => 'form-control',
                        ];
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <textarea class="form-control" name="alamat" id="alamat" style="height: 150px"><?= old('alamat', $user['alamat']); ?></textarea>
                    </div>
                </div>
                <div class="form-group row">
